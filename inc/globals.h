...
int do9A, do9B, do9K, do9PAA, do9PAB, do9PBB;
int do10A, do10B, do10K, do10W, do10PAA, do10PAB, do10PBB;
int do11A, do11B, do11C, do11E, do11F, do11W, do11PAA, do11PAB, do11PBB;
int do12A, do12B, do12D, do12E, do12K, do12PAA, do12PAB, do12PBB;
...
int n9A, n9B, n9K, n9PAA, n9PBB, n9PAB;
int n10A, n10B, n10K, n10W,n10PAA, n10PAB, n10PBB;
int n11A, n11B, n11C, n11E, n11F, n11W,n11PAA, n11PAB, n11PBB;
int n12A, n12B, n12D, n12E, n12K, n12PAA, n12PBB, n12PAB;
...
int m9A, m9B, m9K, m9PAA, m9PBB, m9PAB;
int m10A, m10B, m10K, m10W, m10PAA, m10PAB, m10PBB;
int m11A, m11B, m11C, m11E, m11F, m11W, m11PAA, m11PAB, m11PBB;
int m12A, m12B, m12D, m12E, m12K, m12PAA, m12PBB, m12PAB;
...
int **hc9A, **hc9B, **hc9K, **hc9PAA, **hc9PBB, **hc9PAB;
int **hc10A, **hc10B, **hc10K, **hc10W, **hc10PAA, **hc10PAB, **hc10PBB;
int **hc11A, **hc11B, **hc11C, **hc11E, **hc11F, **hc11W, **hc11PAA, **hc11PAB, **hc11PBB;
int **hc12A, **hc12B, **hc12D, **hc12E, **hc12K, **hc12PAA, **hc12PBB, **hc12PAB;
...
char *s9A, *s9B, *s9K,*s9PAA, *s9PBB, *s9PAB;
char *s10A, *s10B, *s10K, *s10W, *s10PAA, *s10PAB, *s10PBB;
char *s11A, *s11B, *s11C, *s11E, *s11F, *s11W, *s11PAA, *s11PAB, *s11PBB;
char *s12A, *s12B, *s12D, *s12E, *s12K, *s12PAA, *s12PBB, *s12PAB;
