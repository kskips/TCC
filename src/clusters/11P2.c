...
#include "8P.h"
#include "11P2.h"
//!  A 11P2 is a 10P with an additional particle
/*!
* 11P2 is a 10P cluster with an sp3a at one end. 
...
*/
    ...
    for(int g = 0; g<2; ++g){
        ...
        for (int new_3_id = 0; new_3_id < nsp3a; ++new_3_id ){ //iterate over all sp3a rings
            ...
            if(nring_in_cluster(old_10P_cluster, new_3_cluster, 11) == 2){
                if(nring_bonded_nbonded(bonded_id, nbonded_id, new_3_cluster) == 2){ //two particles in ring are in 6Z
                   int bond_counter = check_ring_bonds(new_3_cluster, arr_6Z);
                    if (bond_counter == 9){
                        ...
                        if (check_unique11P2(old_10P_cluster, new_part, 11) == 0){
                            add_11P2(bonded_id, nbonded_id_2, bonded_id_2, nbonded_id,spindle_id, spindle_id_2, final_part1, final_part2, final_part3, final_part4, new_part);
                            }
                        }
                    }
                }
...
void add_11P2(int bonded_id, int nbonded_id_2, int bonded_id_2, int nbonded_id, int spindle_id, int spindle_id_2, int final_part1, int final_part2, int final_part3, int final_part4, int new_particle) {
    ...
    if (n11P2 == m11P2) {
        hc11P2 = resize_2D_int(hc11P2, m11P2, m11P2 + incrStatic, clusSize, -1);
        m11P2 = m11P2 + incrStatic;
    }
    hc11P2[n11P2][0] = bonded_id;
    hc11P2[n11P2][1] = nbonded_id_2;
    hc11P2[n11P2][2] = bonded_id_2;
    hc11P2[n11P2][3] = nbonded_id;
    hc11P2[n11P2][4] = spindle_id;
    hc11P2[n11P2][5] = spindle_id_2;
    hc11P2[n11P2][6] = final_part1;
    hc11P2[n11P2][7] = final_part2;
    hc11P2[n11P2][8] = final_part3;
    hc11P2[n11P2][9] = final_part4;
    hc11P2[n11P2][10] = new_particle;

    for (int i = 0; i < 11; ++i) {
        s11P2[hc11P2[n11P2][i]] = 'B';
    }
    ++n11P2;
}
    ...
    for (int old_11P2_id = 0; old_11P2_id < n11P2; ++old_11P2_id) {
        ...
        for (int q = 0; q<new_clust_size; ++q){
            for (int r = 0; r<10; ++r){
                ...
                if(hc11P2[old_11P2_id][q] == old_clust[r]){
                    u += 1;
                }
            }
        ...
        for (int p = 0; p<new_clust_size; ++p){
            if(hc11P2[old_11P2_id][p] == new_particle){
                    u += 1;
                }
        }
    if(u == new_clust_size){
