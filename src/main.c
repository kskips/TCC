...
char* cluster_names[] = {"sp3a", "sp3b", "sp3c", "sp4a", "sp4b", "sp4c", "sp5a", "sp5b", "sp5c","6A",
                         ...
                         "8PBB", "8A", "8B", "8K","9A", "9B", "9K", "9PAA", "9PAB", "9PBB","10A", "10B","10K", 
                         "10W", "10PAA", "10PAB", "10PBB", "11A", "11B", "11C", "11E", "11F", "11W", 
                         "11PAA", "11PAB", "11PBB", "12A", "12B", "12D","12E", "12K", "12PAA", "12PAB",  
                         "12PBB","13A", "13B", "13K", "13PAA", "13PAB", "13PBB","FCC", "HCP", "BCC_9", "-1"};

int cluster_size[] = {3, 4, 5, 4, 5, 6, 5, 6, 7,
                      6, 6, 7, 7, 7, 7, 8, 8, 8, 8, 8, 8, 9, 9, 9, 9, 9, 9,
                      10, 10, 10, 10, 10, 10, 10, 11, 11, 11, 11, 11, 11, 11, 11, 11, 
                      12, 12, 12, 12, 12, 12, 12, 12, 13, 13, 13, 13, 13, 13, 13,  13, 9, -1};
...
int* do_cluster_list[] = {&dosp3a, &dosp3b, &dosp3c, &dosp4a, &dosp4b, &dosp4c, &dosp5a, &dosp5b, &dosp5c, &do6A,
                          ...
                          &do8K, &do9A, &do9B, &do9K, &do9PAA, &do9PAB, &do9PBB, &do10A, &do10B, &do10K, 
                          &do10W, &do10PAA, &do10PAB, &do10PBB, &do11A, &do11B, &do11C, &do11E, &do11F, &do11W, 
                          &do11PAA, &do11PAB, &do11PBB, &do12A, &do12B, &do12D, &do12E, &do12K, &do12PAA, &do12PAB,
                          &do12PBB, &do13A, &do13B, &do13K, &do13PAA, &do13PAB, &do13PBB,
...
int* num_cluster_list[] = {&nsp3a, &nsp3b, &nsp3c, &nsp4a, &nsp4b, &nsp4c, &nsp5a, &nsp5b, &nsp5c,
                           ...
                           &n8B, &n8K, &n9A, &n9B, &n9K, &n9PAA, &n9PAB, &n9PBB, &n10A, &n10B,
                           &n10K, &n10W, &n10PAA, &n10PAB, &n10PBB, &n11A, &n11B, &n11C, 
                           &n11E, &n11F, &n11W, &n11PAA, &n11PAB, &n11PBB, &n12A, &n12B, &n12D,
                           &n12E, &n12K, &n12PAA, &n12PAB, &n12PBB, &n13A, &n13B, &n13K, &n13PAA, &n13PAB, &n13PBB,
...
char** raw_list[] = {&ssp3a, &ssp3b, &ssp3c, &ssp4a, &ssp4b, &ssp4c, &ssp5a, &ssp5b, &ssp5c,
                     ...
                     &s8B, &s8K, &s9A, &s9B, &s9K, &s9PAA, &s9PAB, &s9PBB, &s10A, &s10B,
                     &s10K, &s10W, &s10PAA, &s10PAB, &s10PBB, &s11A, &s11B, &s11C, &s11E, 
                     &s11F, &s11W, &s11PAA, &s11PAB, &s11PBB, &s12A, &s12B, &s12D,
                     &s12E, &s12K, &s12PAA, &s12PAB, &s12PBB, &s13A, &s13B, &s13K, &s13PAA, &s13PAB, &s13PBB,
...
int*** cluster_list[] = {&hcsp3a, &hcsp3b, &hcsp3c, &hcsp4a, &hcsp4b, &hcsp4c, &hcsp5a, &hcsp5b, &hcsp5c,
                         ...
                         &hc8A, &hc8B, &hc8K, &hc9A, &hc9B, &hc9K, &hc9PAA, &hc9PAB, &hc9PBB, &hc10A, &hc10B,
                         &hc10K, &hc10W, &hc10PAA, &hc10PAB, &hc10PBB, &hc11A, &hc11B, &hc11C, 
                         &hc11E, &hc11F, &hc11W, &hc11PAA, &hc11PAB, &hc11PBB, &hc12A, &hc12B, &hc12D,
                         &hc12E, &hc12K, &hc12PAA, &hc12PAB, &hc12PBB, &hc13A, &hc13B, &hc13K, &hc13PAA, &hc13PAB, &hc13PBB,
...
int* cluster_list_width[] = {&msp3a, &msp3b, &msp3c, &msp4a, &msp4b, &msp4c, &msp5a, &msp5b, &msp5c,
                             ...
                             &m8B, &m8K, &m9A, &m9B, &m9PAA, &m9PAB, &m9PBB, &m9K, &m10A, &m10B,
                             &m10K, &m10W, &m10PAA, &m10PAB, &m10PBB, &m11A, &m11B, 
                             &m11C, &m11E, &m11F, &m11W, &m11PAA, &m11PAB, &m11PBB, &m12A, &m12B, &m12D,
                             &m12E, &m12K, &m12PAA, &m12PAB, &m12PBB, &m13A, &m13B, &m13K, &m13PAA, &m13PAB, &m13PBB,
